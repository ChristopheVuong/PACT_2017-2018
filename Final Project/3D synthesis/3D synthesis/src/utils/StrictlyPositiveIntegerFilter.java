 ...
 */
public final class StrictlyPositiveIntegerFilter extends DocumentFilter {

	private final String text;

	public StrictlyPositiveIntegerFilter(final String text) {
		this.text = text;
	}

	public StrictlyPositiveIntegerFilter() {
		this(null);
	}
