...
/**
 * Permet de vérifier que les données entrées par l'utilisateur sont bien des entiers positifs, et de lui notifier dans le cas contraire.
 */
public final class PositiveIntegerFilter extends DocumentFilter {
	 ...
	 * <p>
	 * Si on n'a pas un entier positif avec le nouvelle input, afficher une erreur et invalider la nouvelle entrée.
	 */
	@Override
	...
	/**
	 * Méthode permettant de vérifier que l'input est bien un entier positif.
	 */
