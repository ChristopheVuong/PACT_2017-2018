...
public final class Sphere implements DrawInterface {
	...
	private void draw(final ViewerInterface viewer, Vertexf4D[] vertices) {
		...
		Vertexf4D[] verticesY180 = rotateVerticesY.dotKeep(verticesY90);
		Vertexf4D[] verticesY270 = rotateVerticesY.dotKeep(verticesY180);
		Vertexf4D[] verticesX180 = rotateVerticesX.dotKeep(vertices);
		Vertexf4D[] verticesX180Y90 = rotateVerticesY.dotKeep(verticesX180);
		Vertexf4D[] verticesX180Y180 = rotateVerticesY.dotKeep(verticesX180Y90);
		Vertexf4D[] verticesX180Y270 = rotateVerticesY.dotKeep(verticesX180Y180);
