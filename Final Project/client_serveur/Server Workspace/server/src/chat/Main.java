...
/**
 * Lance la communication et permet d'en choisir la durée
 */
public final class Main {
	...
	public static void main(final String[] args) throws InterruptedException {
		...
		final JLabel label = new JLabel("Choose the number of seconds during which the communication will be available at the maximum (enter end_stream in the console if you want to end it before that)");
		constraints.gridy = 0;
